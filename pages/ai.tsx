...
export default function AIPolicyPage() {
	return (
		<MainLayout>
			<Head>
				<title>how i use ai • zyplos&apos;s stuff</title>
				<meta
					name="description"
					content="ai is a tool i use. here's a comprehensive view of how i use it"
				/>
				<meta name="viewport" content="width=device-width, initial-scale=1" />
				<link rel="icon" href="/favicon.ico" />

				<meta property="og:title" content="how i use ai • zyplos's stuff" />
				<meta property="og:type" content="website" />
				<meta property="og:url" content="https://zyplos.dev/ai" />
				<meta
			...
			<article className={styles.article}>
				...
				<p>
					...
					unique work of talented people, i understand the sentiment. i have a
					good number of friends and acquaintances who are artists and i respect
					their opinions and work
				</p>
				...
				<CaptionedImage
					...
					caption={"Neat! Interesting, even. But no. Credits: Imagen 3 / Whisk"}
					className={styles.padded}
				/>
